...
| 파일 가져오기 | build 52 다중 선택·폴더별 batch·원자적 실패/Undo, build 53 폴더 관리·오류 복구, build 54 섹션 검색·시작 박/트랙 지정과 실제 오디오/MIDI/batch·Undo ([QA](../qa/library-placement-review.md)) | 중첩 폴더 catalog dedup·실제 file promise·직접 배치 gesture |
