...
| 파일 가져오기 | build 52 다중 선택·폴더별 batch·원자적 실패/Undo, build 53 동명 폴더 관리·오류 복구·등록 해제 보존 ([QA](../qa/library-folders-review.md)) | 중첩 폴더 catalog dedup·실제 file promise·직접 배치 gesture |
