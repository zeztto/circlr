...
상태: 운영 규약 확정. 시작 기준은 `0.20.0 build152`, 최신 출고 대상은 **0.80.0 build242** (`v0.80.0`)이다. 2026-09-25 사용자 이월 결정으로 남은 영상 품질 FAIL·실기기 OPEN을 공개한 채 정식 게시한다. 출고 여부는 원격 Release·자산 검증으로, 검증 범위는 버전 문서의 원 판정으로 판단한다.
