...
운영 전환: 현재 실행은 [버전 단위 운영](releases/README.md)과 [0.30.0 계획](releases/0.30.0.md)을 따른다. 아래 여섯 흐름은 상세 기술 backlog이며 버전 범위를 자동으로 늘리지 않는다. build151 당시 현황은 [인수인계](178-development-handoff.md)에 보존한다.
