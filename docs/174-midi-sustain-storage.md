...
기준: `c7a7ea7`의 독립 CC64 타입 이후, [계획173](173-midi-sustain-plan.md)의 첫 연결 단계. 앱 build 번호는149이며 설치 앱은 교체하지 않았다. 프로젝트 데이터 보존과 출력 거절 경계를 구현한 단계다. 실제 페달 소리·SMF parser·GUI/MCP 페달 편집은 다음 단계다.
