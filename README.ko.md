...
![build235의 f0r h3r와 일곱 곡 섹션](docs/images/circlr-song-build235.png)

*0.80.0 build235 개발 미리보기: 격리된 실제 앱 화면입니다. 최신 정식판은 0.70.0입니다. [촬영 정보](docs/images/README.md).*

> **0.70.0 · build180.** 검증한 조건에서 재생 캔버스와 MP4 캡처를 개선하고, 감상 모드를 녹화 버튼 옆에 놓았습니다. [증거와 제한](docs/releases/0.70.0-qa.md).

**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 곡 궤도에 섹션 순번·시간을 표시하고, 좁은 창에서도 선택한 섹션을 도구 모음에서 앞뒤로 옮길 수 있습니다. build235는 기본 입력 녹음을 앱 소유 별도 프로세스로 격리해 장치가 멈춰도 녹음 조작이 무기한 묶이지 않도록 하고 로컬 AI socket 요청도 제한합니다. 오프라인 MCP helper는 선택 MIDI 편집·바운스를 다루지만 Codex 계정 대화는 아닙니다. 실제 장치 녹음·청취·장시간 영상과 계정 콘솔 QA는 열려 있습니다. 구형 Scarlett의 정상 동작은 전제하지 않으며 최신 정식판은 0.70.0입니다. [현재 QA](qa/0.80-build235.md).
...
<img src="docs/images/circlr-song-portrait-build235.png" width="280" alt="build235 세로 창에서 일곱 곡 섹션과 반응형 조작">

*같은 build235 데모를 정지한 720×900 세로 창입니다. 반응형 섹션 조작과 일곱 섹션을 보여줍니다. [촬영 정보](docs/images/README.md).*
