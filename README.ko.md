...
![build209에서 재생 중인 f0r h3r 곡 궤도와 현재 섹션](docs/images/circlr-song-build209.png)

*0.80.0 build209 개발 미리보기: 격리된 실제 앱 화면입니다. 최신 정식판은 0.70.0입니다. [촬영 정보](docs/images/README.md).*

> **0.70.0 · build180.** 검증한 조건에서 재생 캔버스와 MP4 캡처를 개선하고, 감상 모드를 녹화 버튼 옆에 놓았습니다. [증거와 제한](docs/releases/0.70.0-qa.md).

**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 처음 재생할 때 곡 전체 궤도를 보여주고, 조밀한 섹션의 라벨을 줄이며 재생·녹화·편집·출력 동선을 검증합니다. 필수 QA가 열려 있으며 최신 정식판은 0.70.0입니다.
...
<img src="docs/images/circlr-song-portrait-build209.png" width="280" alt="build209 세로 창에서 재생 중인 곡 궤도">

*같은 build209 데모의 720×900 세로 창으로, 두 줄 상단 조작을 보여줍니다. [촬영 정보](docs/images/README.md).*
