...
**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 궤도 가독성을 높이고 재생·녹화·편집·출력의 전체 작업 흐름을 검증합니다. 현재 빌드에는 MIDI·오디오 편집 화면 유지와 MCP 작업별 취소를 추가했습니다. 기본 출력 장치가 멈추면 **⌘,**에서 앱 전용 출력 장치를 선택할 수 있습니다. 필수 QA가 열려 있으며 최신 정식판은 0.70.0입니다.
