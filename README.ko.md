...
**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 궤도 가독성을 높이고 재생·녹화·편집·출력의 전체 작업 흐름을 검증합니다. build207에서는 구버전 복구본과 다른 앱의 socket을 보존하면서 새 MCP 연결을 만들고, 열린 앱을 기본 연결로 다시 선택할 수 있습니다. MIDI·오디오 편집 화면 유지, MCP 작업별 취소, **⌘,**의 앱 전용 출력 장치 선택도 개발 중입니다. 필수 QA가 열려 있으며 최신 정식판은 0.70.0입니다.
