...
![바흐 Invention 8의 섹션 궤도와 연결된 MIDI·악기·출력 서클](docs/images/circlr-bach-build184.jpg)

*0.80.0 build184 개발 미리보기: 실제 검증 앱의 짧은 녹화에서 추출한 프레임입니다. 최신 정식판은 0.70.0입니다. [촬영 정보](docs/images/README.md).*

> **0.70.0 · build180.** 검증한 조건에서 재생 캔버스와 MP4 캡처를 개선하고, 감상 모드를 녹화 버튼 옆에 놓았습니다. [증거와 제한](docs/releases/0.70.0-qa.md).

**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 궤도 가독성을 높이고 재생·녹화·편집·출력의 전체 작업 흐름을 검증합니다. 현재 빌드에는 MIDI·오디오 편집 화면 유지와 MCP 작업별 취소를 추가했습니다. 필수 QA가 열려 있으며 최신 정식판은 0.70.0입니다.
