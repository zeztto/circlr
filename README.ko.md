...
![build221의 f0r h3r와 일곱 섹션 순번을 보여 주는 곡 궤도](docs/images/circlr-song-build221.png)

*0.80.0 build221 개발 미리보기: 격리된 실제 앱 화면입니다. 최신 정식판은 0.70.0입니다. [촬영 정보](docs/images/README.md).*

> **0.70.0 · build180.** 검증한 조건에서 재생 캔버스와 MP4 캡처를 개선하고, 감상 모드를 녹화 버튼 옆에 놓았습니다. [증거와 제한](docs/releases/0.70.0-qa.md).

**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 곡 궤도에 섹션 순번·시간을 표시하고, 선택한 섹션을 `⇧⌥←/→`로 옮기며, WAV/stems 출력을 보강합니다. 전체 제작·실제 청취·장시간 녹화 QA는 열려 있으며 최신 정식판은 0.70.0입니다. [현재 QA](qa/0.80-build221.md).
...
<img src="docs/images/circlr-song-portrait-build221.png" width="280" alt="build221 세로 창의 순번이 표시된 곡 궤도">

*같은 build221 데모를 정지한 720×900 세로 창으로, 두 줄 상단 조작과 섹션 순번을 보여줍니다. [촬영 정보](docs/images/README.md).*
