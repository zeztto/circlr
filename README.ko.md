...
![곡의 시간 궤도 주변으로 섹션이 펼쳐지는 써클러](docs/images/circlr-landscape-build166.jpg)

*동봉 f0r h3r 프로젝트를 연 실제 0.50.0 build166 앱입니다. [촬영 정보](docs/images/README.md).*

> **0.50.0 · build166 — 게시 대기.** 궤도 밖으로 펼치는 배치와 반응형 조작 UI를 제공합니다. 실제 창 너비 1440·1024·900·700pt와 긴 제목을 확인했습니다. [검증 기록](docs/releases/0.50.0-qa.md).
...
![긴 프로젝트 제목과 반응형 조작부가 표시된 세로 창](docs/images/circlr-portrait-build166.jpg)

구현된 개발 기능의 목록이며 모든 오디오 장치·플러그인의 호환성을 보증하지 않습니다. 아티스트 프로필과 텍스트·이미지·영상을 함께 관리하는 도구는 [장기 목표](docs/21-artist-universe.md)입니다.

## 시작하기

현재 후보는 **0.50.0 build166**이며 `v0.50.0` 게시를 준비 중입니다. 내려받을 수 있는 Apple Silicon 패키지는 [GitHub Releases](https://github.com/zeztto/circlr/releases)에서 확인하세요. 소스는 `main`에서 빌드할 수 있습니다.
...
0.50은 시간 궤도 주변으로 섹션과 신호 노드를 펼치고, 가로·세로 창에 맞춰 상단 조작부를 배치합니다. 곡/섹션 루프·감상 조작·시작 템플릿·데모4곡은 유지합니다. [릴리스 노트](docs/releases/0.50.0-notes.md)를 참고하세요.
