...
![build237의 f0r h3r와 일곱 곡 섹션](docs/images/circlr-song-build237.png)

*0.80.0 build237 개발 미리보기: 격리된 실제 앱 화면입니다. 최신 정식판은 0.70.0입니다. [촬영 정보](docs/images/README.md).*

> **0.70.0 · build180.** 검증한 조건에서 재생 캔버스와 MP4 캡처를 개선하고, 감상 모드를 녹화 버튼 옆에 놓았습니다. [증거와 제한](docs/releases/0.70.0-qa.md).

**개발 중:** [0.80.0](docs/releases/0.80.0.md)은 곡 궤도에 섹션 순번·시간을 표시하고, 좁은 창에서도 도구 모음으로 섹션 순서를 바꿀 수 있습니다. build236은 CoreMIDI 연주 시각을 보존하고 Stem 게시를 정지 동작과 맞추며 콘솔의 과거 로그 위치를 유지합니다. build237은 밀집 로그 유입 중 재생 화면 반응을 개선했습니다. 격리 앱의 내부 animation count gate는 두 번 통과했지만 두 번째 여유는 작았습니다. 앱 소유 오프라인 MCP helper의 프로젝트 저장·앱 지정 WAV 출력은 현재 turn에 허용된 경우에만 가능하며 Codex 계정 대화는 아닙니다. 실제 장치 녹음·청취·화면 FPS 측정·장시간 영상·계정 콘솔 QA는 열려 있습니다. 구형 Scarlett의 정상 동작은 전제하지 않으며 최신 정식판은 0.70.0입니다. [현재 QA](qa/0.80-build237.md).
...
<img src="docs/images/circlr-song-portrait-build237.png" width="280" alt="build237 세로 창에서 일곱 곡 섹션과 반응형 조작">

*같은 build237 데모를 정지한 720×900 세로 창입니다. 반응형 섹션 조작과 일곱 섹션을 보여줍니다. [촬영 정보](docs/images/README.md).*
