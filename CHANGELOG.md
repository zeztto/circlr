...
- 녹화 동시 실행은 화면 그리기26.29Hz, 출력 파일 평균17.32fps로 아직 성능 기준에 못 미친다. 60Hz 실제 표시·섹션 전환·녹화 프레임/AV 동기 native QA가 남아 있어 태그·정식 릴리스 전이다. [계획과 증거](docs/releases/0.70.0.md).
