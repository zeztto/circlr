...
extension AppStore {
    ...
    var audioCommandAvailable:Bool {currentAudioClip != nil && !(NSApp.keyWindow?.firstResponder is NSTextView) && !navigationOpen && commandPalette==nil && !keyboardHelp && !hierarchySettingsOpen}
