...
@MainActor final class AppStore: ObservableObject {
    ...
    func undo() {
        cancelRecordingRequest();guard !midiRecording && !audioRecording else{status="녹음을 정지한 뒤 실행 취소하세요";return}
    ...
    func redo() {
        cancelRecordingRequest();guard !midiRecording && !audioRecording else{status="녹음을 정지한 뒤 다시 실행하세요";return}
