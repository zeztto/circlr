...
public struct InputCaptureWorkerMessage:Codable,Sendable {
    public enum Kind:String,Codable,Sendable {case start,stop,started,progress,finished,failed}
    ...
    public init(session:UUID,kind:Kind,directory:String?=nil,maximumSeconds:Double?=nil,
        ...
        self.maximumSeconds=maximumSeconds;self.sampleRate=sampleRate;self.channels=channels
