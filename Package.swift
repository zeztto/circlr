...
let package = Package(
    name: "circlr",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "circlr", targets: ["CirclrApp"]), .executable(name: "circlr-studio", targets: ["CirclrStudioTool"]), .executable(name: "circlr-output-worker", targets: ["CirclrOutputWorker"]), .executable(name: "circlr-au-effect-worker", targets: ["CirclrAUEffectWorker"])],
    targets: [
