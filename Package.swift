...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "CirclrInputWorker",dependencies:["CirclrAudio"],path:"Tools/CirclrInputWorker"),
