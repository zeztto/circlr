#!/usr/bin/env python3
"""Guarded client for the build 37 authored fixture; no microphone capture."""
...
qa.OUT = qa.ROOT / 'qa/generated/midi-grid-workspace'
qa.FIXTURE = qa.FIXTURE.with_name('midi-grid-workspace.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/midi-grid-workspace')).upper()
