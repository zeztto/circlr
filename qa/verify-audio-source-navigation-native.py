#!/usr/bin/env python3
"""Capture build 49 audio source navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/audio-source-navigation'
qa.FIXTURE = qa.FIXTURE.with_name('audio-source-navigation.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/audio-source-navigation')).upper()
