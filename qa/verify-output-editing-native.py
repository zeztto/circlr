...
qa.OUT = qa.ROOT / 'qa/generated/output-editing'
qa.FIXTURE = qa.FIXTURE.with_name('output-editing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output-editing')).upper()
