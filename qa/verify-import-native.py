#!/usr/bin/env python3
"""Use the existing guarded QA client against the exact import fixture. No recording."""
...
qa.OUT = qa.ROOT / 'qa/generated/import'
qa.FIXTURE = qa.FIXTURE.with_name('import.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/import')).upper()
