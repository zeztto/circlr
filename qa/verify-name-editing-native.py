#!/usr/bin/env python3
"""Capture build 45 committed project state separately from the UI's name draft."""
...
qa.OUT = qa.ROOT / 'qa/generated/name-editing'
qa.FIXTURE = qa.FIXTURE.with_name('name-editing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/name-editing')).upper()
