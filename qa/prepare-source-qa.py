...
FIXTURE = SOURCE.with_name('source-circles.circlr')
...
def main():
    ...
    if args.candidate:
        ...
        assert current['id'] == str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/source-circles')).upper()
    ...
    assert info['CFBundleShortVersionString'] == '0.20.0' and info['CFBundleVersion'] == '27'
    ...
    if not args.candidate:
        ...
        project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/source-circles')).upper()
    ...
    project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/source-circles')).upper()
    result = dict(app=str(APP), fixture=str(FIXTURE), projectID=project['id'], build='27',
