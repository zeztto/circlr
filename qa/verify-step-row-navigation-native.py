#!/usr/bin/env python3
"""Capture build 47 drum row navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/step-row-navigation'
qa.FIXTURE = qa.FIXTURE.with_name('step-row-navigation.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/step-row-navigation')).upper()
