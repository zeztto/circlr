#!/usr/bin/env python3
"""Capture build 59 direct section and circle navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/direct-work-navigation'
qa.FIXTURE = qa.FIXTURE.with_name('direct-work-navigation.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/direct-work-navigation')).upper()
