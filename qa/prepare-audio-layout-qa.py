#!/usr/bin/env python3
"""Package a separate audio-layout app and authored fixture."""
import hashlib
...
p.NAME='audio-layout';p.BUILD='73';p.OUT=p.ROOT/'qa/generated/audio-layout'
p.APP=p.OUT/'써클러 통합 검증.app';p.FIXTURE=p.SOURCE.with_name('audio-layout.circlr')
