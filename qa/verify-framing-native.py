#!/usr/bin/env python3
"""Use the existing guarded QA client against the exact framing fixture. No recording."""
...
qa.OUT = qa.ROOT / 'qa/generated/framing'
qa.FIXTURE = qa.FIXTURE.with_name('framing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/framing')).upper()
