#!/usr/bin/env python3
"""Guarded build 42 fixture client; never starts playback or recording."""
...
qa.OUT = qa.ROOT / 'qa/generated/midi-placement'
qa.FIXTURE = qa.FIXTURE.with_name('midi-placement.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/midi-placement')).upper()
