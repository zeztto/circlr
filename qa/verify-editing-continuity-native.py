#!/usr/bin/env python3
"""Guarded client for the build 35 authored fixture; no microphone capture."""
...
qa.OUT = qa.ROOT / 'qa/generated/editing-continuity'
qa.FIXTURE = qa.FIXTURE.with_name('editing-continuity.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/editing-continuity')).upper()
