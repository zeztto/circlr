#!/usr/bin/env python3
"""Guarded build 41 fixture client. No device playback or capture."""
...
qa.OUT = qa.ROOT / 'qa/generated/connection-workspace'
qa.FIXTURE = qa.FIXTURE.with_name('connection-workspace.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/connection-workspace')).upper()
