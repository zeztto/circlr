#!/usr/bin/env python3
"""Capture only the owned build83 project; never starts playback or recording."""
...
q.OUT=q.ROOT/'qa/generated/arrangement-workspace'
...
def capture(name):
 ...
 s=q.state();assert s['runtime']['build']=='83' and s['output']['attempts']==0 and s['audition']['attempts']==0
