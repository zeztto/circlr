...
qa.OUT = qa.ROOT / 'qa/generated/source-circles'
qa.FIXTURE = qa.FIXTURE.with_name('source-circles.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/source-circles')).upper()
