#!/usr/bin/env python3
"""Package build 68 with authored section branches and a separate owner."""
import copy
import hashlib
...
packager.NAME='editor-position';packager.BUILD='68'
packager.OUT=packager.ROOT/'qa/generated/editor-position';packager.APP=packager.OUT/'써클러 통합 검증.app'
packager.FIXTURE=packager.SOURCE.with_name('editor-position.circlr')


def identifier(name):return str(uuid.uuid5(uuid.NAMESPACE_URL,'circlr-integration-qa/editor-position/'+name)).upper()
...
if __name__=='__main__':
    ...
    sources=['Resources/Info.plist', 'Sources/CirclrCore/EditorViewportState.swift', 'Sources/CirclrCore/MIDIOrbitViewport.swift', 'Sources/CirclrCore/AudioSourceViewport.swift', 'Sources/CirclrCore/AutomationViewport.swift', 'Sources/CirclrCore/StudioWorkspace.swift', 'Sources/CirclrApp/EditorScrollMemory.swift', 'Sources/CirclrApp/EditorWorkspace.swift', 'Sources/CirclrApp/InlineCircleEditor.swift', 'Sources/CirclrApp/AppStore.swift', 'Sources/CirclrApp/AlbumCanvas.swift', 'Sources/CirclrApp/SavedWorkspace.swift', 'Sources/CirclrApp/EditorView.swift', 'Sources/CirclrApp/MIDIGridWorkspace.swift', 'Sources/CirclrApp/MIDIOrbitWorkspace.swift', 'Sources/CirclrApp/AudioWorkspace.swift', 'Sources/CirclrApp/StepEditor.swift']
