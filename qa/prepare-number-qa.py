...
FIXTURE = SOURCE.with_name('number-editing.circlr')
...
def main():
    ...
    if args.candidate:
        ...
        assert current['id'] == str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/number-editing')).upper()
    ...
    assert info['CFBundleShortVersionString'] == '0.20.0' and info['CFBundleVersion'] == '29'
    ...
    if not args.candidate:
        ...
        project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/number-editing')).upper()
    ...
    project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/number-editing')).upper()
    result = dict(app=str(APP), fixture=str(FIXTURE), projectID=project['id'], build='29',
