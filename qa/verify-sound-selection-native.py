#!/usr/bin/env python3
"""Capture build 60 sound selection without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/sound-selection'
qa.FIXTURE = qa.FIXTURE.with_name('sound-selection.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/sound-selection')).upper()
