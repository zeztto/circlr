#!/usr/bin/env python3
"""Capture build 46 pitch navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/pitch-navigation'
qa.FIXTURE = qa.FIXTURE.with_name('pitch-navigation.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/pitch-navigation')).upper()
