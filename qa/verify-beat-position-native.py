#!/usr/bin/env python3
"""Capture build 55 musical position display without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/beat-position'
qa.FIXTURE = qa.FIXTURE.with_name('beat-position.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/beat-position')).upper()
