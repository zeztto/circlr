...
packager.NAME = 'midi-orbit-workspace'
packager.BUILD = '36'
packager.OUT = packager.ROOT / 'qa/generated/midi-orbit-workspace'
packager.APP = packager.OUT / '써클러 통합 검증.app'
packager.FIXTURE = packager.SOURCE.with_name('midi-orbit-workspace.circlr')
...
if __name__ == '__main__':
    ...
    sources = ['Resources/Info.plist', 'Sources/CirclrApp/InlineCircleEditor.swift',
               ...
               'Sources/CirclrCore/MIDIOrbitViewport.swift']
