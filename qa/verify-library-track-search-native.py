#!/usr/bin/env python3
"""Capture build 58 searchable audio target tracks without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/library-track-search'
qa.FIXTURE = qa.FIXTURE.with_name('library-track-search.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/library-track-search')).upper()
