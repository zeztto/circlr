#!/usr/bin/env python3
"""Capture build 51 MIDI selection tools without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/midi-selection-tools'
qa.FIXTURE = qa.FIXTURE.with_name('midi-selection-tools.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/midi-selection-tools')).upper()
