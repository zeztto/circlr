...
동일 D2 앱의 후속 전면 재생에서 그룹 신호를 확인했고, 녹음과 합친 0.20.0 build 23에서도 10개 전면 표본의 두 출력 모션·편집/Undo/바운스/저장을 확인했다. [통합 QA](daw-integration-review.md). 아래는 당시 D2 체크포인트의 증거이며 cold start timeout 원인의 해결을 뜻하지 않는다.
