#!/usr/bin/env python3
"""Guarded client for the build 38 authored fixture; no microphone capture."""
...
qa.OUT = qa.ROOT / 'qa/generated/audio-workspace'
qa.FIXTURE = qa.FIXTURE.with_name('audio-workspace.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/audio-workspace')).upper()
