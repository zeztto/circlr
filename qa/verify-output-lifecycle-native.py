...
qa.OUT = qa.ROOT / 'qa/generated/output-lifecycle'
qa.FIXTURE = qa.FIXTURE.with_name('output-lifecycle.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output-lifecycle')).upper()
