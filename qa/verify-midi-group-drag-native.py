#!/usr/bin/env python3
"""Capture build 50 MIDI group drag without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/midi-group-drag'
qa.FIXTURE = qa.FIXTURE.with_name('midi-group-drag.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/midi-group-drag')).upper()
