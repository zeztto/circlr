...
packager.NAME = 'audio-workspace'
packager.BUILD = '38'
packager.OUT = packager.ROOT / 'qa/generated/audio-workspace'
packager.APP = packager.OUT / '써클러 통합 검증.app'
packager.FIXTURE = packager.SOURCE.with_name('audio-workspace.circlr')

if __name__ == '__main__':
    packager.main()
    sources = ['Resources/Info.plist', 'Sources/CirclrApp/AudioWorkspace.swift',
               'Sources/CirclrApp/OrbitAudioEditor.swift', 'Sources/CirclrApp/EditorKeyboard.swift',
               'Sources/CirclrCore/AudioEditing.swift', 'Sources/CirclrCore/AudioSourceViewport.swift',
