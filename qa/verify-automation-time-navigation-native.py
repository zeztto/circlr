#!/usr/bin/env python3
"""Capture build 48 automation time navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/automation-time-navigation'
qa.FIXTURE = qa.FIXTURE.with_name('automation-time-navigation.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/automation-time-navigation')).upper()
