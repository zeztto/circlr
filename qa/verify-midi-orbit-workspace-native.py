#!/usr/bin/env python3
"""Guarded client for the build 36 authored fixture; no microphone capture."""
...
qa.OUT = qa.ROOT / 'qa/generated/midi-orbit-workspace'
qa.FIXTURE = qa.FIXTURE.with_name('midi-orbit-workspace.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/midi-orbit-workspace')).upper()
