#!/usr/bin/env python3
"""Capture build 56 viewing preferences and edit history without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/view-history'
qa.FIXTURE = qa.FIXTURE.with_name('view-history.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/view-history')).upper()
