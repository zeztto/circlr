#!/usr/bin/env python3
"""Use the existing guarded QA client against the exact output fixture. No recording."""
...
qa.OUT = qa.ROOT / 'qa/generated/output'
qa.FIXTURE = qa.FIXTURE.with_name('output.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output')).upper()
