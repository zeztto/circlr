#!/usr/bin/env python3
"""Package a separate selection-reveal app and authored fixture."""
import hashlib
...
p.NAME='selection-reveal';p.BUILD='72';p.OUT=p.ROOT/'qa/generated/selection-reveal'
p.APP=p.OUT/'써클러 통합 검증.app';p.FIXTURE=p.SOURCE.with_name('selection-reveal.circlr')
SOURCES=['Resources/Info.plist','Sources/CirclrApp/MIDIGridWorkspace.swift','Sources/CirclrApp/EditorView.swift']
