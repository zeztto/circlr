...
qa.OUT = qa.ROOT / 'qa/generated/library-editing'
qa.FIXTURE = qa.FIXTURE.with_name('library-editing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/library-editing')).upper()
