#!/usr/bin/env python3
"""Package build102 against the preserved connection-access QA document."""
...
p.NAME='connection-access';p.BUILD='102';p.OUT=p.ROOT/'qa/generated/connection-access'
p.APP=p.OUT/'써클러 통합 검증.app';p.FIXTURE=p.SOURCE.with_name('connection-access.circlr')
