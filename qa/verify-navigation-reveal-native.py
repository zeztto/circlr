#!/usr/bin/env python3
"""Capture build 57 transient group reveal and navigation without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/navigation-reveal'
qa.FIXTURE = qa.FIXTURE.with_name('navigation-reveal.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/navigation-reveal')).upper()
