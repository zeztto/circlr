...
def main():
    ...
    assert info['CFBundleShortVersionString'] == '0.20.0' and info['CFBundleVersion'] == '25'
    ...
    project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output')).upper()
    ...
    result = dict(app=str(APP), fixture=str(FIXTURE), projectID=project['id'], build='25',
