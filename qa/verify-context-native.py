...
qa.OUT = qa.ROOT / 'qa/generated/context-editing'
qa.FIXTURE = qa.FIXTURE.with_name('context-editing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/context-editing')).upper()
