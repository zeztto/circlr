...
qa.OUT = qa.ROOT / 'qa/generated/effect-editing'
qa.FIXTURE = qa.FIXTURE.with_name('effect-editing.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/effect-editing')).upper()
