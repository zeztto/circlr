#!/usr/bin/env python3
"""Capture build 52 library batch import without starting an audio device."""
...
qa.OUT = qa.ROOT / 'qa/generated/library-batch'
qa.FIXTURE = qa.FIXTURE.with_name('library-batch.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/library-batch')).upper()
