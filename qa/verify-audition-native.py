#!/usr/bin/env python3
"""Read/save the build 43 authored fixture; never starts microphone or MIDI input."""
...
qa.OUT = qa.ROOT / 'qa/generated/audition-worker'
qa.FIXTURE = qa.FIXTURE.with_name('audition-worker.circlr')
qa.PROJECT_ID = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/audition-worker')).upper()
