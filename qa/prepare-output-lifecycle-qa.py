...
def main():
    ...
    if args.candidate:
        ...
        assert current['id'] == str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output-lifecycle')).upper()
    ...
    assert info['CFBundleShortVersionString'] == '0.20.0' and info['CFBundleVersion'] == '32'
    ...
    if not args.candidate:
        ...
        project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output-lifecycle')).upper()
    ...
    project['id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, 'circlr-integration-qa/output-lifecycle')).upper()
    result = dict(app=str(APP), fixture=str(FIXTURE), projectID=project['id'], build='32',
