#!/usr/bin/env python3
"""Package build 69 with authored section branches and a separate owner."""
import copy
import hashlib
...
packager.NAME='midi-inspector';packager.BUILD='69'
packager.OUT=packager.ROOT/'qa/generated/midi-inspector';packager.APP=packager.OUT/'써클러 통합 검증.app'
packager.FIXTURE=packager.SOURCE.with_name('midi-inspector.circlr')


def identifier(name):return str(uuid.uuid5(uuid.NAMESPACE_URL,'circlr-integration-qa/midi-inspector/'+name)).upper()
...
if __name__=='__main__':
    ...
    sources=['Resources/Info.plist', 'Sources/CirclrApp/MIDINoteInspector.swift', 'Sources/CirclrCore/MIDIEditing.swift', 'Sources/CirclrCore/AgentProtocol.swift', 'mcp/server.py', 'Resources/Codex/manifest.json', 'Resources/Codex/skills/circlr-studio/scripts/mcp_server.py', 'Resources/Codex/skills/circlr-studio/references/circlr-operations.md']
